---
name: orchestrate
description: Portable workflow for orchestrate requests. Load only when selected by router.
---

# orchestrate

Portable workflow for orchestrate requests. Load only when selected by router.

Source: shared/frozen-sources/repos/antigravity-kit/.agent/workflows/orchestrate.md (upstream: ai-repos/antigravity-kit/.agent/workflows/orchestrate.md)
