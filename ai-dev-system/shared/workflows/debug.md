---
name: debug
description: Portable workflow for debug requests. Load only when selected by router.
---

# debug

Portable workflow for debug requests. Load only when selected by router.

Source: shared/frozen-sources/repos/antigravity-kit/.agent/workflows/debug.md (upstream: ai-repos/antigravity-kit/.agent/workflows/debug.md)
