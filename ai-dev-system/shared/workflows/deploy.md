---
name: deploy
description: Portable workflow for deploy requests. Load only when selected by router.
---

# deploy

Portable workflow for deploy requests. Load only when selected by router.

Source: shared/frozen-sources/repos/antigravity-kit/.agent/workflows/deploy.md (upstream: ai-repos/antigravity-kit/.agent/workflows/deploy.md)
