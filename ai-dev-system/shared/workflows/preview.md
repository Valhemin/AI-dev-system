---
name: preview
description: Portable workflow for preview requests. Load only when selected by router.
---

# preview

Portable workflow for preview requests. Load only when selected by router.

Source: shared/frozen-sources/repos/antigravity-kit/.agent/workflows/preview.md (upstream: ai-repos/antigravity-kit/.agent/workflows/preview.md)
