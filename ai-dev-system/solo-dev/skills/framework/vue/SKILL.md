---
name: vue-dev
description: Imported community guidance converted into a local SKILL.md. Use for vue development, debugging, review, and implementation tasks.
---

# vue-dev

Source: shared/frozen-sources/repos/awesome-cursorrules/rules/vue-3-nuxt-3-development-cursorrules-prompt-file/README.md (upstream: ai-repos/awesome-cursorrules/rules/vue-3-nuxt-3-development-cursorrules-prompt-file/README.md)
