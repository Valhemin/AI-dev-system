---
name: angular-dev
description: Imported community guidance converted into a local SKILL.md. Use for angular development, debugging, review, and implementation tasks.
---

# angular-dev

Source: shared/frozen-sources/repos/awesome-cursorrules/rules/angular-typescript-cursorrules-prompt-file/README.md (upstream: ai-repos/awesome-cursorrules/rules/angular-typescript-cursorrules-prompt-file/README.md)
