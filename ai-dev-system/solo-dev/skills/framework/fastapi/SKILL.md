---
name: fastapi-dev
description: Imported community guidance converted into a local SKILL.md. Use for fastapi development, debugging, review, and implementation tasks.
---

# fastapi-dev

Source: shared/frozen-sources/repos/awesome-cursorrules/rules/python-fastapi-best-practices-cursorrules-prompt-f/README.md (upstream: ai-repos/awesome-cursorrules/rules/python-fastapi-best-practices-cursorrules-prompt-f/README.md)
