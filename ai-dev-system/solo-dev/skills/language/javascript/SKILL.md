---
name: javascript-dev
description: Imported community guidance converted into a local SKILL.md. Use for JavaScript, Node.js, browser code, npm tooling, and runtime errors.
---

# javascript-dev

Source: shared/frozen-sources/repos/awesome-cursorrules/rules/javascript-typescript-code-quality-cursorrules-pro/README.md (upstream: ai-repos/awesome-cursorrules/rules/javascript-typescript-code-quality-cursorrules-pro/README.md)
